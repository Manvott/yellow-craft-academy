...
function RegistroForm() {
  ...
  // ── PASO 1: Unirse al canal ──────────────────────────────────────────────────
  if (paso === 'canal') {
    return (
      <div style={{ padding: '2.5rem 0' }}>
        {/* Cabecera */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
          <div style={{ width: 48, height: 48, background: 'var(--crema3)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: '1.4rem' }}>1</div>
          <div>
            <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.8rem', fontWeight: 300, color: 'var(--negro)', lineHeight: 1 }}>
              Únete al canal de WhatsApp
            </p>
            <p style={{ fontSize: '0.78rem', color: 'var(--gris)', marginTop: '0.3rem' }}>
              Paso obligatorio para confirmar tu plaza
            </p>
          </div>
        </div>

        {/* Bloque canal */}
        <div style={{ background: 'var(--negro)', padding: '1.75rem', marginBottom: '1.25rem' }}>
          <p style={{ fontSize: '0.62rem', letterSpacing: '0.3em', textTransform: 'uppercase', color: 'rgba(247,243,238,0.4)', marginBottom: '0.75rem', fontFamily: 'DM Sans, sans-serif' }}>
            Paso 1 de 2
          </p>
          <p style={{ fontSize: '0.9rem', color: 'var(--crema)', lineHeight: 1.65, marginBottom: '1.25rem' }}>
            Únete al canal de difusión del evento. Recibirás toda la información, cambios y novedades de Yellow Craft Academy directamente en WhatsApp.
          </p>
          <a
    ...
    return (
      <div style={{ padding: '2.5rem 0' }}>
        ...
        <p style={{ fontSize: '0.87rem', color: 'var(--gris)', lineHeight: 1.85, marginBottom: '1.5rem' }}>
          Enhorabuena {nombreInscrito}, tu plaza está reservada. Nos vemos el 15 de junio.
        </p>
